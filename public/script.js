...
if (window.MAINTENANCE_CONFIG && window.MAINTENANCE_CONFIG.isMaintenance) {
    ...
    // Gaidām, kad ielādējas DOM, lai varētu droši modificēt lapu
    document.addEventListener('DOMContentLoaded', () => {
        // 1. Paslēpjam ielādes (loading) ekrānu, ja tāds ir
        const loading = document.getElementById('loading');
        if (loading) loading.remove();

        // 2. Izveidojam pilnekrāna apkopes bloku ar CSS stiliem, kas saskan ar tavu tēmu
        ...
        // 3. Ievietojam tekstus no maintenance.js
        ...
        // 4. Pievienojam ekrānu dokumentam un nobloķējam ritināšanu
        document.body.appendChild(maintenanceOverlay);
        document.body.style.overflow = 'hidden';
    });

    // Pārtraucam skripta tālāko izpildi, lai nekas cits nedarbotos
    throw new Error("Application paused due to maintenance mode.");
}
