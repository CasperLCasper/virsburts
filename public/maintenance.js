...
if (window.MAINTENANCE_CONFIG.isMaintenance) {
    ...
    document.documentElement.innerHTML = `
        <head>
            <title>\${window.MAINTENANCE_CONFIG.title} — Maintenance</title>
        ...
        <body>
            <div class="container">
                ...
                <div class="badge">\${window.MAINTENANCE_CONFIG.subtitle}</div>
                <p>\${window.MAINTENANCE_CONFIG.description}</p>
            </div>
        </body>
    `;
}
